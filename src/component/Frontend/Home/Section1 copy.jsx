            ...
            {itemData.slice(0, 4).map((item) => (
              ...
              >
                ...
                <div
                  ...
                  className="skew-x-6 absolute z-10 p-1 animate-ping-border rounded-full bottom-2 left-4 flex items-center justify-center"
                >
                ...
                {showText[item.id] && (
                  <div
                    ...
                    className="absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-0 skew-x-12 z-50 w-36 md:w-40 bg-gray-100 p-3 rounded"
                  >
            ...
            {itemData.slice(4, 8).map((item) => (
              ...
              >
                ...
                {showText[item.id] && (
                  <div
                    ref={(el) => (textRefs.current[item.id] = el)}
                    className="absolute bottom-44 left-1/2 transform -translate-x-1/2 -translate-y-0 skew-x-12 z-50 w-40 bg-gray-100 p-3 rounded"
                  >
                    <div className="flex justify-between">
                      <p className="text-gray-600">kidverz</p>
                      <div className="bg-gray-300 rounded-full size-6 flex justify-center items-center">
