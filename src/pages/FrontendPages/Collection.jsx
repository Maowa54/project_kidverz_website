          ...
          <div className="flex justify-between">
            ...
            <div className="hidden md:block">
              ...
              <button
                ...
                className={`text-white bg-sky-400 rounded-sm p-2 hover:bg-sky-500 ${
              ...
              <button
                ...
                className={`ml-2 text-white bg-sky-400 rounded-sm p-2 hover:bg-sky-500 ${
                  ...
                  return (
                    ...
                    >
                      <div className="group bg-gray-100 relative">
                        ...
                        {/* New Product Badge */}
                        {newProduct && (
                          <div className="absolute top-2 left-2 text-white starburst px-2 py-1">
                            New
                          </div>
                        )}
                        ...
                        <div className="absolute flex justify-center gap-2 bottom-4 w-full opacity-0 group-hover:opacity-100 transition-transform duration-300 transform translate-y-full group-hover:translate-y-1">
                          {[
                            ...
                            <div
                              key={index}
                              className="size-7 md:size-8 text-sm bg-gray-800 flex justify-center items-center rounded hover:bg-[#EB1E39] transition duration-300"
                            >
                              {link ? (
                                <Link to={link}>
                  ...
                  return (
                    ...
                    >
                      <div className="bg-gray-100 relative group">
                        ...
                        {/* New Product Badge */}
                        {newProduct && (
                          <div className="absolute top-2 left-2 text-white bg-red-500 rounded-full px-2 py-1 text-xs font-semibold">
                            New
                          </div>
                        )}
                        ...
                        <div className="absolute flex justify-center gap-2 bottom-4 w-full opacity-0 group-hover:opacity-100 transition-transform duration-300 transform translate-y-full group-hover:translate-y-1">
                          {[
                            ...
                            <div
                              key={index}
                              className="size-7 md:size-8 bg-gray-800 flex justify-center items-center text-sm rounded hover:bg-[#EB1E39] transition duration-300"
                            >
                              {link ? (
                                <Link to={link}>
                                  <i className={`text-white ${icon}`}></i>
